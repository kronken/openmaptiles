...
curl -sSfL "http://dev.hsl.fi/osm.finland/finland.osm.pbf" -o data/finland.osm.pbf
...
docker-compose -f docker-compose.yml -f ./docker-compose-config.yml  run --rm generate-vectortiles
...
md5sum ./docker-compose-config.yml       >> ./data/quickstart_checklist.chk
